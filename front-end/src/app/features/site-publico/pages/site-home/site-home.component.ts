  ...
  template: `
    ...
    <div class="hero-section">
      <div class="hero-content">
        <h1>Bem-vindo à <br> <span class="highlight">{{ storeInfo?.name || 'Nova Aliança' }}</span></h1>
        <p class="subtitle">{{ storeInfo?.description || 'A melhor padaria da região, com pães frescos a toda hora.' }}</p>
        
        <div class="cta-group">
          <a class="main-cta" routerLink="/cardapio">
            Ver Nosso Cardápio
          </a>
        </div>
      </div>
