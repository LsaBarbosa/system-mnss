...
@Component({
  ...
  styles: [`
    ...
    .cart-header {
      ...
      h2 { margin: 0; font-size: 1.3rem; color: #172126; }
      p { margin: 5px 0 0; color: #5a6970; font-size: 0.9rem; }
    }
    ...
    .prod-info {
      display: flex;
      flex-direction: column;
      strong { font-size: 0.95rem; color: #233239; }
      span { font-size: 0.85rem; color: #1d8f62; font-weight: 700; margin-top: 4px; }
    }
    ...
    .form-group {
      ...
      flex-direction: column;
      gap: 4px;
      label { font-size: 0.85rem; font-weight: 600; color: #5a6970; }
      select, textarea {
        padding: 10px;
        border: 1px solid #d4dde1;
        border-radius: 6px;
        font-family: inherit;
        &:focus { border-color: #f1b74a; outline: none; }
      }
    ...
    .total-line {
      ...
      margin-bottom: 16px;
      span { color: #5a6970; }
      strong { font-size: 1.4rem; color: #172126; }
    }
