...
@Component({
  ...
  template: `
    <div class="chat-viewport">
      ...
      <div class="input-bar">
        <input type="text" placeholder="Escreva sua mensagem..." [(ngModel)]="newMessage" (keyup.enter)="onSend()" />
        <button class="send-btn" (click)="onSend()" [disabled]="!newMessage.trim()">Enviar</button>
      </div>
    </div>
  `,
  styles: [
